            ...
            <div class="card position-sticky top-0">
              <div class="p-3 bg-light bg-opacity-10">
                ...
                <div class="d-flex justify-content-between mb-1 h4">
                  <span>Subtotal</span> <span>${{ number_format($orderDetails['total_amount'], 2)}}</span>
                </div>
                <div class="d-flex justify-content-between mb-1 h4">
                ...
                <div class="d-flex justify-content-between mb-4 h4">
                  <span>TOTAL</span> <strong class="text-dark">${{ number_format($orderDetails['total_amount'], 2)}}</strong>
                </div>
                ...
                <button type="submit" class="axil-btn btn-bg-primary checkout-btn mt-2">Place order</button>
              </div>
            </div>
          </div>
        </div>
