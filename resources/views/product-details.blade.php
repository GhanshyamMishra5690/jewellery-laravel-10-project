                        ...
                        <div class="col-lg-10 order-lg-2">
                            <div class="single-product-thumbnail-wrap zoom-gallery">
                                <div class="single-product-thumbnail product-large-thumbnail-3 axil-product">
                                    <div class="thumbnail">
                                        <a href="{{$products->full_stone_image}}" class="popup-zoom">
                                            <img src="{{$products->full_stone_image}}" alt="Product Images">
                                        </a>
                                    </div>
                                    <div class="thumbnail">
                                        <a href="{{$products->full_setting_image}}" class="popup-zoom">
                                            <img src="{{$products->full_setting_image}}" alt="Product Images">
                                        </a>
                                    </div>
 
                                </div>
                                <div class="label-block">
                                    <div class="product-badget">AAA20% OFF</div>
                                </div>
                        ...
                        <div class="col-lg-2 order-lg-1">
                            <div class="product-small-thumb-3 small-thumb-wrapper">
                                <div class="small-thumb-img">
                                    <img src="{{$products->full_stone_image}}" alt="thumb image">
                                </div>
                                <div class="small-thumb-img">
                                    <img src="{{$products->full_setting_image}}" alt="thumb image">
                                </div>
                ...
                <div class="col-lg-5 mb--40">
                    <div class="single-product-content">
                        <div class="inner">
                            ...
                            <p class="description">{{$products->setting_description}}</p>
                                ...
                                <div class="product-variation"> 
                                    <div class="row" style="border-bottom: 2px solid #f6f7fb;">
                                        <div class="col-6 form-group">
                                            <h6 class="title">Shape: <span class="title-value">{{$products->shape}}</span></h6>
                                        </div>
                                        <div class="col-6 form-group">
                                            <h6 class="title">Metal Type: <span class="title-value">{{$products->metal_type}}</span></h6>
                                        </div>
                                        <div class="col-6 form-group">
                                            <h6 class="title">Setting Style: <span class="title-value">{{$products->setting_style}}</span></h6>
                                        </div> 
                                        <div class="col-6 form-group">
                                            <h6 class="title">Setting Style: <span class="title-value">{{$products->setting_style}}</span></h6>
                                        </div> 
                                        <div class="col-6 form-group">
                                            <h6 class="title">Band Type: <span class="title-value">{{$products->band_type}}</span></h6>
                                        </div> 
                                        <div class="col-6 form-group">
                                            <h6 class="title">Setting Profile: <span class="title-value">{{$products->setting_profile}}</span></h6>
                                        </div> 
                                        <div class="col-6 form-group">
                                            <h6 class="title">Stone Type: <span class="title-value">{{$products->stone_type}}</span></h6>
                                        </div> 
                                    </div>
